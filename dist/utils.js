...
(function (global, factory) {
    ...
    exports.isNoE = isNullOrEmpty;

    exports.isNoB = isNullOrBlank;
    exports.isNum = isNum;
    exports.isInt = isInt;
    ...
    exports.isNaturalStr = isNaturalStr;
    exports.isMoneyStr = isMoneyStr;
    ...
    exports.parseNumFormat = parseNumFormat;
    exports.formatNum = formatNum;
    exports.formatBool = formatBool;

    exports.replace = replace;
    exports.merge = merge;
    exports.guessLineSeperator = guessLineSeperator;
    exports.makeCsvLine = makeCsvLine;
    exports.parseCsvLine = parseCsvLine;
    exports.toPaginatedData = toPaginatedData;
    exports.copyAsArray = copyAsArray;
    exports.copyByFilter = copyByFilter;
    exports.moveArrayElementsAt = moveArrayElementsAt;
    exports.compareArrays = compareArrays;
    exports.makeDiffHoursStr = makeDiffHoursStr;
    exports.sortArray = sortArray;
    exports.asTimeout = asTimeout;
    exports.repeatChecker = repeatChecker;

    exports.isLeapYear = isLeapYear;
    exports.getYearMonthDays = getYearMonthDays;
    exports.getYearMonthWeekDates = getYearMonthWeekDates;
    ...
    exports.getDomElStyle = getDomElStyle;
    exports.getPageInfo = getPageInfo;
    exports.setPageTitle = setPageTitle;
    exports.setPageUrl = setPageUrl;
    exports.escapeHtmlStr = escapeHtmlStr;
    exports.escapeXmlValueStr = escapeXmlValueStr;

    exports.parseDimen = parseDimen;
    exports.openWindow = openWindow;
    exports.openWindowForHtml = openWindowForHtml;
    exports.closePageWindow = closePageWindow;
    exports.escapeHtmlStr = escapeHtmlStr;
    exports.calcTrackerDim = calcTrackerDim;

    exports.loadJs = loadJs;
    exports.loadCss = loadCss;

    exports.extractShortFileName = extractShortFileName;
    exports.extractFileNameExt = extractFileNameExt;
    exports.buildFilePath = buildFilePath;

    exports.isImageFile = isImageFile;
    exports.isImageType = isImageType;

    exports.addFileNamePart = addFileNamePart;
    exports.getMailHomeUrl = getMailHomeUrl;

    exports.genUniqueStr = genUniqueStr;
    exports.makeUniqueUrl = makeUniqueUrl;
    exports.makeUrl = makeUrl;
    exports.parseUrl = parseUrl;
    exports.extractUrlParams = extractUrlParams;
    exports.jsonToUrlParams = jsonToUrlParams;

    exports.getAppRelUrlInfo = getAppRelUrlInfo;
    exports.getServerBase = getServerBase;
    exports.getServerBasedUrl = getServerBasedUrl;
    exports.getWebSocket = getWebSocket;

    exports.base64StrToDataURL = base64StrToDataURL;
    exports.playAudio = playAudio;
    exports.speakText = speakText;

    exports.filterTitleStr = filterTitleStr;
    exports.checkTitleStr = checkTitleStr;
